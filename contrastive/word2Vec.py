...
from contrastive.utils import _debug
...
class Word2VecModel:
    ...
    def __init__(self, vector_size=50, min_count=1, workers=multiprocessing.cpu_count() - 1, debug=False, lang="english", detect_bigrams=False, epochs=30):
    ...
    def _cleaning(self, doc):
        ...
        """
        return [
            self._stemmer.stem(wordFiltered.lower()) for wordFiltered in word_tokenize(doc) if
            wordFiltered not in self._stop_words and wordFiltered.isalpha()
        ]
